...
//  Expense Tracker
//
//  Created by Tímea Kónya on 13.02.2025.
//
...
struct LockView<Content: View>: View {
    ...
    @State private var animateFiled: Bool = false
    ...
    private func NumberPadPinView() -> some View {
        VStack(spacing: 15) {
            ...
            .keyframeAnimator(initialValue: CGFloat.zero, trigger: animateFiled, content: { content, value in
                content
                    .offset(x: value)
            }, keyframes: { _ in
                KeyframeTrack {
